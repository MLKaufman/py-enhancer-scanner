...
class EnhancerScan:
    ...
    def write_genbank(self, file_name):
        #TODO: output whole region to genbank with enhancer annotations and primers?
        #grab whole region plus padding
        #store as bio.seq
        #create annotations for each enhancer
        #create annotations for each primer
        pass
    ...
    def get_primers(self, file_name, padding=0, primer_walk=False, infusionf=None, infusionr=None, verbose=False):
        ...
        for index, enhancer in self.df_results.iterrows():
            ...
            #TODO:handle infusion overhangs
            if infusionf is not None and infusionr is not None:
                pass
